...
class AppException(Exception):
    """
    AppException is customized exception class designed to capture refined details about exception such as python script file line number along with error message.
    ...
    def error_message_detail(error:Exception, error_detail:sys):
        ...
        error_detail: is sys module contains etial information about system execution information.
        """
